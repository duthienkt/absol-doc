...
```js
var clazz = absol.require('SelectColorSchemeMenu');
```
...
- `js/colorpicker/SelectColorSchemeMenu.js`

### Demo

- https://absol.cf/libs/absol-acomp/demo/SelectColorSchemeMenu.html
