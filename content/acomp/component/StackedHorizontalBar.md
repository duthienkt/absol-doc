...
```js
var clazz = absol.require('stackedhorizontalbar');
```
...
- `js/StackedHorizontalBar.js`

### Demo

- https://absol.cf/libs/absol-acomp/demo/stackedhorizontalbar.html
